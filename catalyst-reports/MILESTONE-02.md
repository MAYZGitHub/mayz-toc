...
- **Detailed Architecture Documentation**: Provide comprehensive documentation of the smart contract architecture, defining the roles and interactions of each component, including the Protocol Contract, OTC Contract, and OTC NFT Minting Policy.
- **Diagram of Transaction Flow**: Include visuals, such as transaction flow diagrams, to support the documentation and clarify the various operational flows (e.g., Protocol Creation, OTC Creation, Claiming, Closing).
- **Initial Codebase**: Establish the initial repository structure for smart contracts, written in Aiken, as a strategic decision to stay aligned with the latest developments in Cardano's Plutus V3 framework.

## Architectural Highlights

The architecture, detailed in the [README] in the `smart-contracts` folder(./smart-contracts/README.md), is comprised of three core smart contract components:
...
The following transaction provide a visual breakdown of key operations in the OTC smart contract system:
...
<img src="../smart-contracts/charts/OTC-Close-Tx.png" width="800px"> <img src="../smart-contracts/charts/OTC-Cancel-Tx.png" width="800px">
...
- **Adaptation with Cardano’s Evolution**: Aiken is designed to work with the advancements in Cardano and Plutus V3, providing a more efficient and developer-friendly tool for smart contract development.
- **Learning Opportunity**: Moving to Aiken allows us to gain experience with the latest Cardano tools, helping us deepen our understanding of Plutus V3 and build skills that will be valuable in future projects.
- **Community Contribution**: As early adopters of Aiken, we can also provide feedback that may help improve the ecosystem, which benefits other developers working on Cardano.

**This transition, while causing a slight delay, gives us a chance to work with newer Cardano technology.** Using Aiken aligns our project with current developments in the Cardano ecosystem and supports our learning goals.
...
Each file under the `validators` directory contains key logic for different contract roles in the architecture, while the `charts` directory includes transaction flow diagrams that visually represent the smart contract interactions.
...
- **Milestone 03**: Focus on completing and testing the smart contracts, initially written in Aiken, ensuring full functionality according to the established architecture.
- **Feedback Integration**: Incorporate any comments or suggestions from Catalyst reviewers to improve the documentation and implementation strategy.
